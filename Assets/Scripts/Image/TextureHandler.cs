...
namespace OpenVIII
{
    ...
    public class TextureHandler : IDisposable
    {
        ...
        public int ClassicWidth => (int)(ClassicSize == Vector2.zero ? Size.x : ClassicSize.y);
        ...
        public void Save(string outPath, bool replace)
        {
            ...
            && (Textures != null && Textures.Length > 0 && Textures[0, 0] != null))
                ...
                UnityEngine.Debug.Log($"{this} :: Textures is null or empty! :: {Filename}");
        }
        ...
        /// <returns></returns>
        public Rect Trim(Rect src) => _process(Rectangle.Empty, src, Color.TransparentBlack, _Trim_SingleTexture);
